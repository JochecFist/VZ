...
Pro podporu těchto vyvíjejících se příběhů hra také obsahuje hiearchii orkské společnosti, která umožňuje povyšování, degradování a posuny moci mezi orkama. Navíc se tento systém dynamicky přizpůsobuje na základě výkonu hráče a přináší výzvy nebo příležitosti k udržení příběhového napětí. Systém Nemesis prosperuje na základě zapojení a interpretace hráče, což umožňuje vznik různých příběhů, díky kterým vznikají individuálních zkušenosti a herní prožitky.