...
Ve druhé kapitole se zmiňujou základy strojového učení a také existující čtyři typy strojového učení:
\begin{enumerate}
...
Kapitola třetí obsahuje návrh autonomního agenta. Především obsahuje návrh samotného prostředí, kde se agent bude učit a zároveň testovat jeho inteligenci. Dále tato kapitola obsahuje dva algoritmy, SARSA a Deep Q-Learning, které budou použity pro sestrojení agenta pro 3D akční hru.
