...
\graphicspath{{./Kapitoly/1/Obrazky/} {./Kapitoly/2/Obrazky/} {./Kapitoly/3/Obrazky/} {./Kapitoly/4/Obrazky/}}
...
\newcommand{\logoCVUT}{\includegraphics{./Zadani+Grafika/symbol_cvut_konturova_verze_cb.pdf}} % logo ČVUT -- podle grafického manuálu ČVUT platného od prosince 2016. Pokud nevyhovuje PDF-verze, tak použijte jinou variantu loga: https://www.cvut.cz/logo-a-graficky-manual -> "Symbol a logo ČVUT v Praze"). Pokud chcete logo úplně vynechat, zadejte místo "\includegraphics{...}" text "\vspace{35mm}"

% přesně podle formuláře "Zadání bak./dipl. práce" VYPLŇTE:
\newcommand{\nazevcz}{Strojové učení pro adaptaci autonomních agentů}    % český název práce (přesně podle zadání!)
\newcommand{\nazeven}{Machine learning for the adaptation of autonomous agents}          % anglický název práce (přesně podle zadání!)
...
\newcommand{\klicova}{autonomní agent, hry, umělá inteligence, adaptace, strojové učení}   % zde NAPIŠTE česky max. 5 klíčových slov
\newcommand{\keyword}{autonomous agent, games, artificial intelligence, adaptation, machine learning}       % zde NAPIŠTE anglicky max. 5 klíčových slov (přeložte z češtiny)
\newcommand{\abstrCZ}{Tento výzkumný úkol se zaměřuje na teorii a návrh kombinace umělé inteligence (AI) a strojového učení ve hrách za účelem dynamické úpravy chování herních protivníků v reálném čase. Úkol se skládá ze čtyř částí. První část pojednává o historii a typech umělé inteligence, konkrétně o umělé inteligenci v 3D akčních hrách. Druhá část zahrnuje základy strojového učení a jeho různých algoritmů. Třetí část navrhuje prostředí a algoritmy pro agenty AI v 3D akčních hrách a čtvrtá část nastiňuje metody vyhodnocování výkonu agentů, aby byla zajištěna co nejlepší efektivita agentů v dynamických herních prostředích.}    % zde NAPIŠTE abstrakt v češtině (cca 7 vět, min. 80 slov)
\newcommand{\abstrEN}{This research task focuses on the theory and design of combining Artificial Intelligence (AI) and machine learning in games to dynamically modify the behavior of game opponents in real time. The task consists of four parts. The first part discusses the history and types of AI, specifically AI in 3D action games. The second part covers the basics of machine learning and it's various algorithms. The third part proposes environments and algorithms for an AI agent in 3D action games, and the fourth part outlines methods for evaluating agent performance to ensure the best agent effectiveness in dynamic game environments.} % zde NAPIŠTE abstrakt v angličtině

\newcommand{\prohlaseni}{Prohlašuji, že jsem výzkumný úkol vypracoval\woman{} samostatně a použil\woman{} jsem pouze podklady (literaturu, projekty, SW atd.) uvedené v~přiloženém seznamu.} % text prohlášení můžete mírně upravit :-)

\newcommand{\podekovani}{Děkuji Ing. Josefovi Novému, Ph.D. za vedení mého výzkumného úkolu a pomoc při jeho tvorbě.} % NAPIŠTE poděkování, např. svému vedoucímu:
...
\input{./Kapitoly/Uvod/Uvod.tex}

\chapter{AI ve hrách}

\input{./Kapitoly/1/1.tex}

\chapter{Strojové učení (Machine Learning - ML)}

\input{./Kapitoly/2/2.tex}

\chapter{Návrh autonomního agenta}

\input{./Kapitoly/3/3.tex}

\chapter{Návrhy hodnocení agenta}

\input{./Kapitoly/4/4.tex}

\chapter*{Závěr} % SEM NESAHEJTE!
\addcontentsline{toc}{chapter}{Závěr} % SEM NESAHEJTE!

\input{./Kapitoly/Zaver/Zaver.tex}
