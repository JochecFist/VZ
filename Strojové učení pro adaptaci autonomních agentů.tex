...
\graphicspath{{./Kapitoly/1/Obrazky/} {./Kapitoly/2/Obrazky/}}
...
\newcommand{\autor}{Martin Jochec}   % vyplňte své jméno a příjmení (s akademickým titulem, máte-li jej)
...
\newcommand{\podekovani}{Děkuji Ing. Josefovi Novému, Ph.D. za vedení mého výzkumného úkolu a pomoc při jeho tvorbě a také ??? za kontrolu správnosti textu výzkumného úkolu.} % NAPIŠTE poděkování, např. svému vedoucímu:
...
\chapter{AI ve hrách a Teorie o strojovém učení}

\input{./Kapitoly/1/1.tex}

\chapter{Návrh algoritmů pro adaptaci a hodnocení agenta}
